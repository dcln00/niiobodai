...
div
	section#hero(class="pt-32 pb-12 lg:pt-40 lg:pb-16 overflow-hidden relative")
		.container(class="max-w-4xl space-y-6")
			...
			.space-y-4
				...
				.author-row(class="flex items-center gap-3 pt-2")
	...
	section#post(class="py-12 lg:py-20 bg-brand-surface-subtle")
		.container(class="max-w-3xl")
			.article-card(class="rounded-3xl lg:rounded-4xl bg-brand-surface border border-brand-black/8 p-8 sm:p-12 lg:p-16 shadow-[0_4px_30px_rgba(23,22,21,0.03)] space-y-8")
				...
				.author-footer(class="pt-10 border-t border-brand-black/8")
					store-author(:compact="false")
			.pt-8(class="text-center")
