...
section#contact-form(class="pt-40 pb-20 lg:py-60 bg-brand-black")
	.container(class="flex flex-wrap")
		div(class="w-full lg:w-1/2 p-4 max-lg:px-0 space-y-8")
			h2(class="text-2xl lg:text-5xl text-white tracking-tighter" v-motion-slide-bottom :duration="500") Let's Connect
			p(class="text-2xl lg:text-2xl text-white tracking-tighter" v-motion-slide-bottom :delay="200" :duration="500") Have a project or question? Send me a message. I will reply within 48 hours.
			form(novalidate v-motion-slide-bottom :delay="400" :duration="500")
		...
		div(class="w-full lg:w-1/2 p-4 max-lg:px-0 hidden lg:flex items-center")
			div(class="space-y-8 bg-brand-dark w-full lg:w-2/3 p-8 rounded-lg mx-auto" v-motion-slide-visible-once-right :duration="500")
				div
					p(class="text-2xl lg:text-2xl text-white tracking-tighter pb-2") Email Me At
					NuxtLink(to="mailto:info@theniiobodai.com" class="text-lg text-zinc-400") info@theniiobodai.com
				div
					p(class="text-2xl lg:text-2xl text-white tracking-tighter pb-2") Telephone
